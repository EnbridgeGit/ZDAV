FUNCTION Z_AW_TREE_SEARCH40.
*"----------------------------------------------------------------------
*"*"Local interface:
*"       IMPORTING
*"             VALUE(TREENAME) LIKE  DD08T-MESTEXT OPTIONAL
*"             VALUE(TREEDESC) LIKE  DD04T-DDTEXT OPTIONAL
*"             VALUE(LANG) LIKE  SY-LANGU
*"             VALUE(MAX_ROWS) LIKE  SY-TABIX OPTIONAL
*"             VALUE(FLAG) LIKE  SY-TABIX OPTIONAL
*"       TABLES
...
if PN(2) <> '%_'.
   ...
   APPEND 'FORM Z_AW_TREE_SEARCH40_FORM' TO CODETAB.
   ...
   APPEND '' TO CODETAB.
   APPEND 'TABLES: T800S, SETHEADER.' TO CODETAB.
   ...
   APPEND '    CONCATENATE ''*-'' T800S-TAB ''-''' TO CODETAB.
   ...
   APPEND '' TO CODETAB.
   APPEND '* 4.0 style search' TO CODETAB.
   APPEND '* Trees without controlling area' TO CODETAB.
   APPEND 'SELECT * FROM SETHEADER' TO CODETAB.
   APPEND ' WHERE ( SETTYPE = ''S'' OR SETTYPE = ''B'' ).' TO CODETAB.
...
*   APPEND '            TABNAME   = SETHEADER-TABNAME' TO CODETAB.
   ...
   APPEND '  DESCRIBE TABLE ITAB_SUPERSETS LINES NO_ROWS.' TO CODETAB.
   APPEND '  IF NO_ROWS = 0.' TO CODETAB.
   APPEND '    CONCATENATE ''*-'' SETHEADER-TABNAME ''-''' TO CODETAB.
   APPEND '                SETHEADER-FIELDNAME' TO CODETAB.
   APPEND '    INTO ITAB_TREE-TNAME.' TO CODETAB.
   APPEND '    ITAB_TREE-TDESC = SPACE.' TO CODETAB.
   APPEND '    SELECT SINGLE * FROM DD02T' TO CODETAB.
...
PERFORM Z_AW_TREE_SEARCH40_FORM IN PROGRAM (pn)
       TABLES
             P_RETURN
       USING
             TREENAME
...
FORM Z_AW_TREE_SEARCH40_GETV CHANGING VERSION TYPE C.
